        ...
        <div className="absolute inset-0 flex items-center justify-center z-30">
          <div className="text-center px-4">
            ...
            <p className="text-xl text-white max-w-2xl mx-auto">
              Dedicated to promoting sustainability, conservation, and
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Founded with a vision to create positive environmental change, our
              organization brings together passionate advocates, scientists, and
              community leaders dedicated to preserving our planet for future
              generations.
            </p>
            <p className="text-gray-700 mb-6">
              We believe that through education, community engagement, and
              sustainable practices, we can address the most pressing
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-teal-800 text-center mb-3">
              Sustainability
            </h3>
            <p className="text-gray-600 text-center">
              We promote sustainable practices that meet present needs without
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 text-center">
              We believe in the power of community action and collective
        ...
        <div className="max-w-4xl mx-auto bg-teal-700 rounded-xl overflow-hidden shadow-xl">
          <div className="p-8 md:p-12 text-center">
            ...
            <p className="text-green-100 mb-8 max-w-2xl mx-auto">
              Whether you're looking to volunteer, donate, or collaborate, there
              are many ways to support our environmental initiatives and make a
