    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="w-full max-w-md">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">
              Join EcoVision and start making a difference today
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 bg-green-600 relative overflow-hidden hidden lg:block">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1513&q=80")',
        ...
        <div className="relative h-full flex flex-col justify-center px-8 xl:px-16 text-white z-10">
          ...
          <p className="text-lg xl:text-xl mb-4 xl:mb-6">
          ...
          <div className="space-y-4 xl:space-y-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-xs xl:text-sm">
                  Support environmental projects with donations or volunteer
                  your time
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-xs xl:text-sm">
                  See the tangible results of your contributions to
          ...
          <div className="mt-8 xl:mt-12 bg-white/10 rounded-lg p-3 xl:p-4 border border-white/20">
            ...
            <p className="text-right text-xs xl:text-sm mt-1 xl:mt-2">
