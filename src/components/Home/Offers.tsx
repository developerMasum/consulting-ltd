  ...
  const services = [
    {
      ...
      description:
        "From concept to execution, we handle every detail of your event with precision and creativity.",
      features: [
        "Venue Selection",
        "Theme Design",
        "Timeline Management",
    ...
    },
    {
      ...
      description:
        "Elevate your business gatherings with our professional corporate event management services.",
      features: [
        "Conference Planning",
        "Team Building",
        "Product Launches",
    ...
    },
    {
      ...
      description:
        "Create unforgettable moments with our comprehensive wedding planning services.",
      features: [
        "Ceremony Design",
        "Reception Planning",
        "Vendor Management",
    ...
    },
    {
      ...
      description:
        "Delight your guests with exquisite culinary experiences tailored to your event.",
      features: [
        "Menu Planning",
    ...
    },
    {
      ...
      title: "Entertainment",
      description:
        "Keep your guests engaged with our premium entertainment solutions.",
    ...
    },
    {
      ...
      description:
        "Find the perfect location that matches your vision and requirements.",
      features: [
        "Site Visits",
        "Capacity Planning",
        "Layout Design",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {services.map((service, index) => (
            ...
            >
              <div className="p-8">
                <div
                  className={`w-16 h-16 ${service.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500`}
                >
        ...
        >
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            event planners is here to help you every step of the way.
          </p>
          <Link href="/login">
