  ...
  const features = [
    {
      ...
      description:
        "Digital RSVP tracking, seating arrangements, and attendee analytics for all package tiers",
    },
    {
      icon: Calendar,
      title: "Timeline Planning",
      description:
        "Customized event schedules with vendor coordination and contingency planning",
    },
    {
      icon: Gift,
      title: "Vendor Coordination",
      description:
        "Preferred vendor network with negotiated discounts and quality assurance",
    },
    {
      icon: Shield,
      title: "Insurance Coverage",
      description:
        "Comprehensive liability coverage scaled to your event size and requirements",
    },
  ];
    ...
    <section className="py-20 bg-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Flexible packages designed to meet your event needs with
