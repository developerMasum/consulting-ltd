...
export default function EventContact() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setTimeout(() => {
      console.log(values);
      toast.success(
        "Thank you for your inquiry! Our event specialists will contact you within 24 hours.",
        {
          duration: 5000,
        }
      );
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-12 text-center animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-in opacity-0 animate-delay-200">
              From intimate gatherings to grand celebrations, our expert team is
              dedicated to bringing your vision to life with meticulous
          ...
          <div className="bg-card bg-white  rounded-xl shadow-xl p-8 md:p-10 border border-muted/20 animate-fade-in opacity-0 animate-delay-300">
            <div className="mb-8 text-center">
              ...
              <p className="text-muted-foreground">
                Share your event details below and we'll craft a personalized
                proposal tailored to your needs and vision.
              </p>
            </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="group">
                        <FormLabel className="text-foreground/80 group-hover:text-primary transition-colors">
                          Full Name
                        </FormLabel>
                        <FormControl>
                          <Input
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 text-center ">
            <div className="p-6 rounded-lg shadow-md border border-muted/10 transition-all hover:shadow-lg hover:translate-y-[-4px]  z-120 bg-white ">
              ...
              <a
                href="mailto:events@luxecelebrations.com"
          ...
          <div className="mt-16 p-8 bg-primary/5 rounded-xl border border-primary/10 text-center max-w-3xl mx-auto animate-fade-in opacity-0 animate-delay-500 z-120 bg-white">
            ...
            <p className="italic text-foreground/90 mb-4">
              "The team at Luxe Celebrations transformed our vision into an
              unforgettable experience. Their attention to detail and creativity
