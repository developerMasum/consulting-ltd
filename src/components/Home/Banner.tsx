        ...
        <SwiperSlide>
          <div className="relative h-full w-full flex items-center justify-center text-center overflow-hidden">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://image.cdn2.seaart.me/2025-04-01/cvlsf3le878c738gfipg-2/1d0580bde3669d900cbd237bf06f5e3f_high.webp')",
              }}
            >
        ...
        <SwiperSlide>
          <div className="relative h-full w-full flex items-center justify-center text-center overflow-hidden">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://image.cdn2.seaart.me/2025-04-01/cvlsj6le878c73b4grj0-2/ac773b23895b1477b1aa10dfcb38f53a_high.webp')",
              }}
            >
              <div className="absolute inset-0 bg-black/50 "></div>
            </div>
            <div className="relative z-10 text-white px-4 mt-12">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-8">
                {[
                  ...
                  >
                    <item.icon
                      className={`mx-auto w-16 h-16 text-${item.color}-400 mb-4`}
                    />
        ...
        <SwiperSlide>
          <div className="relative h-full w-full flex items-center justify-center text-center overflow-hidden">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://cdn.pixabay.com/photo/2024/02/04/14/38/earth-8552339_1280.jpg')",
              }}
            >
              <div className="absolute inset-0 bg-black/50 "></div>
            </div>
            <div className="relative z-10 text-white px-4">
              ...
              <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 drop-shadow-md animate-slide-up-delay">
                Event management, volunteer coordination, and secure donation
                processing
              </p>
